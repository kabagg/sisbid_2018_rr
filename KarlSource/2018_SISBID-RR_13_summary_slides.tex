...
\item[] Where would we point you?
    \bi
  \item
    \href{https://ropensci.org/blog/2014/10/23/introducing-rocker}{\scriptsize
      \tt ropensci.org/blog/2014/10/23/introducing-rocker}
  \item \href{http://ropenscilabs.github.io/r-docker-tutorial/}{\tt \scriptsize
...
\begin{frame}[c]{Custom Rmd/pandoc templates}
...
\item[] Where would we point you?
    \bi
  \item
    \href{https://bookdown.org/yihui/rmarkdown/document-templates.html}{\scriptsize \tt
...
\begin{frame}[c]{Jupyter notebooks}

  \bbi
\item[] Why is it cool?
  \bi
\item Alternative system for reproducible analysis reports.
\item More interactive than R Markdown
  \ei
\item[] Why didn't we cover it?
    \bi
    \item Note enough time
    \ei
\item[] Where would we point you?
    \bi
  \item \href{http://jupyter.org/}{\tt jupyter.org}
  \item
    \href{https://www.datacamp.com/community/blog/jupyter-notebook-r}{\tt
